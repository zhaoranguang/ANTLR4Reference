...
public class XParser extends Parser {
	...
	public static class SContext extends ParserRuleContext {
		...
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof XListener ) ((XListener)listener).enterS(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof XListener ) ((XListener)listener).exitS(this);
		}
	}
	...
	public static class AddContext extends EContext {
		...
		public TerminalNode ADD() { return getToken(XParser.ADD, 0); }
		public AddContext(EContext ctx) { copyFrom(ctx); }
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof XListener ) ((XListener)listener).enterAdd(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof XListener ) ((XListener)listener).exitAdd(this);
		}
	}
	public static class MultContext extends EContext {
		...
		public TerminalNode MULT() { return getToken(XParser.MULT, 0); }
		public MultContext(EContext ctx) { copyFrom(ctx); }
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof XListener ) ((XListener)listener).enterMult(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof XListener ) ((XListener)listener).exitMult(this);
		}
	}
	public static class IntContext extends EContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof XListener ) ((XListener)listener).enterInt(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof XListener ) ((XListener)listener).exitInt(this);
		}
	}
